    ...
    <>
      <li className={styles.cardTech}>
        ...
        <div className={styles.containerButtons}>
          <button className="iconClicked" onClick={()=> setEditingTech(tech)} title="Editar Tech" area-aria-label="edit">
            <BiSolidPencil color="white" size={20}/>
          </button>
          <button className="iconClicked"  onClick={()=> deleteTech(tech.id)} title="Deletar Tech" area-aria-label="remove">
